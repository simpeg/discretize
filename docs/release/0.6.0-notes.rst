...
* ``grid_cell_centers=gridCC``
* ``grid_nodes=gridN``
* ``grid_edges_x=gridEx``, ``grid_edges_y=gridEy``, ``grid_edges_z=gridEz``
* ``grid_faces_x=gridFx``, ``grid_faces_y=gridFy``, ``grid_faces_z=gridFz``
...
* Also, similar to above: ``grid_hanging_XXX=gridhX``, for each hanging ``node=N``, ``face_x,y,z=Fx,y,z`` and ``edge_x,y,z=Ex,y,z``
...
* ``vectorNx`` → ``grid_nodes_x``, ``vectorNy`` → ``grid_nodes_y``, ``vectorNz`` → ``grid_nodes_z``
* ``vectorCCx`` → ``grid_cell_centers_x``, ``vectorCCy`` → ``grid_cell_centers_y``, ``vectorCCz`` → ``grid_cell_centers_z``
